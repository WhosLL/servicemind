  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--black)', padding: '80px 24px' }}>
      <div style={{ maxWidth: 760, margin: '0 auto', color: 'var(--text-2)', fontSize: 14, lineHeight: 1.9 }}>
        ...
        <p>Plans are billed monthly. Current pricing: $30/mo flat. No booking fees. No cut of tips. You can cancel at any time; your account remains active until the end of the current billing period.</p>
